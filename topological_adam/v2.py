...
class TopologicalAdamV2(torch.optim.Optimizer):
    """Recommended Topological Adam path with richer diagnostics and stopping support."""
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                topo_corr = bounded_topological_correction(topo_corr, adam_dir, max_topo_ratio)
        ...
        if self.stats["num_params"] > 0:
            for key in ("energy", "alpha_norm", "beta_norm", "coupling_current", "coupling", "topo_ratio"):
